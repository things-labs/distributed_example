...
type ArithRequest struct {
	...
	A int32 `protobuf:"varint,1,opt,name=a,proto3" json:"a,omitempty"` // 数字a
	B int32 `protobuf:"varint,2,opt,name=b,proto3" json:"b,omitempty"` // 数值b
}
...
type ArithResponse struct {
	...
	Result int32 `protobuf:"varint,1,opt,name=result,proto3" json:"result,omitempty"` // 结果
}
...
var file_pb_prod_proto_rawDesc = []byte{
	...
	0x01, 0x62, 0x18, 0x02, 0x20, 0x01, 0x28, 0x05, 0x52, 0x01, 0x62, 0x22, 0x27, 0x0a, 0x0d, 0x41,
	0x72, 0x69, 0x74, 0x68, 0x52, 0x65, 0x73, 0x70, 0x6f, 0x6e, 0x73, 0x65, 0x12, 0x16, 0x0a, 0x06,
	0x72, 0x65, 0x73, 0x75, 0x6c, 0x74, 0x18, 0x01, 0x20, 0x01, 0x28, 0x05, 0x52, 0x06, 0x72, 0x65,
	0x73, 0x75, 0x6c, 0x74, 0x32, 0x2d, 0x0a, 0x05, 0x41, 0x72, 0x69, 0x74, 0x68, 0x12, 0x24, 0x0a,
	0x03, 0x4d, 0x75, 0x6c, 0x12, 0x0d, 0x2e, 0x41, 0x72, 0x69, 0x74, 0x68, 0x52, 0x65, 0x71, 0x75,
	0x65, 0x73, 0x74, 0x1a, 0x0e, 0x2e, 0x41, 0x72, 0x69, 0x74, 0x68, 0x52, 0x65, 0x73, 0x70, 0x6f,
...
var file_pb_prod_proto_goTypes = []interface{}{
	(*ArithRequest)(nil),  // 0: ArithRequest
	(*ArithResponse)(nil), // 1: ArithResponse
}
var file_pb_prod_proto_depIdxs = []int32{
	0, // 0: Arith.Mul:input_type -> ArithRequest
	1, // 1: Arith.Mul:output_type -> ArithResponse
